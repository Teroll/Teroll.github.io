...
$secret = '6LcT5EMUAAAAALIUAmPstbqyBMyZN41l8Kbfr626'; // ваш секретный ключ
...
if (isset($_POST['message'])) {
    ...
    if (!checkStringLength($message, 2, 500)) {
        $data['message'] = 'Поле <b>сообщение</b> содержит недопустимое количество символов. Допустимое значение от 2 до 500.';
        $data['result'] = 'error';
    }
} else {
...
$output .= '<p><b>Способ связи:</b> ' . $email . '</p>';
...
$mail = new PHPMailer;
$mail->CharSet = 'UTF-8';
$mail->From = 'p322021@h5.ihc.ru';
$mail->FromName = 'IAMsite';
$mail->isHTML(true);
$mail->Subject = 'Сообщение с формы обратной связи';
$mail->Body = $output;
$mail->AddAddress('khasanoff.evgeny@ya.ru');
//$mail->AddAddress('welcome@iamsite.com');
//$mail->AddAddress('gorshkov@iamsite.com');
